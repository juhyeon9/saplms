...
<script type="text/javascript">
	...
	// 목록 조회
	function fListleccnt(currentPage) {
		...
		var searchcallback = function(returndata) {
			...
			searchcallbackprocess(returndata,currentPage);
	...
	// 목록 콜백 함수
	function searchcallbackprocess(returndata,currentPage) {
		
		$("#listleccnt").empty().append(returndata);
		
		var totalcnt = $("#searchlistcnt").val();
		
		var paginationHtml = getPaginationHtml(currentPage, totalcnt, pagesize, pagenumsize, 'fListleccnt');
		console.log("paginationHtml : " + paginationHtml);
		//swal(paginationHtml);
		$("#comnleccntPagination").empty().append( paginationHtml );
		
		$("#hclickpagenum").val(currentPage);
